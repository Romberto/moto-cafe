...
class TestProductSerializer(TestCase):
    ...
    def test_api_product_serialiser(self):
        ...
        expected_data = [
            OrderedDict(
                [('id', self.product_1.id), ('title', 'title_product_1'), ('price', '1000.00'),
                 ('photo', None),
                 ('description', 'description_product_text'), ('category', self.category_1.id),
                 ('category_title', 'title_1')]),
            OrderedDict(
                [('id', self.product_2.id), ('title', 'title_product_2'), ('price', '2000.00'),
                 ('photo', None),
                 ('description', 'description_product_text'), ('category', self.category_1.id),
                 ('category_title', 'title_1')]),
            OrderedDict(
                [('id', self.product_3.id), ('title', 'title_product_3'), ('price', '1500.00'),
                 ('photo', None),
                 ('description', 'description_product_text'), ('category', self.category_2.id),
